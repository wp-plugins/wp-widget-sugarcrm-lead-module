...
* You will required SugarCRM administrator level credentials to Plug-in it.
* You can use Widget one time only on each page, if will be display 2 time at single page – it will not work.
* Any time you can remove Lead fields from Widget and add any custom field on Widget and it will reflect all over where you have set at your website.
* At time of update “Display Order” values – You must have to select check box which record you want to update.

== Installation ==

1. Install plugin OR unzip the downloaded file to /wp-content/plugins/
2. Go to your plugin settings and enable the plugin.
3. Go to Widget setting and set widget where you have to show Lead Form.
...
2. Is my credentials safe on WordPress?
